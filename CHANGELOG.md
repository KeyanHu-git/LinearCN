...
- 恢复 README 的功能覆盖、下载选择、运行原理、安全边界和维护说明。
- 使用独立的“中”字本地化标志，并改用稳定的 128 像素绝对图片地址展示。

## 1.5.3 - 2026-09-01

### Changed

- 根据最终选择，将项目与扩展图标切换为第一版原创方案。

## 1.5.2 - 2026-09-01

### Changed

- 使用原创 LinearCN 图标替换旧图标。
- 大幅精简 README，突出下载、支持平台和安装步骤。

### Fixed

- 补齐创建团队页面的访问权限、时区说明和复制设置翻译。
