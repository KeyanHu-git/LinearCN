...
for (const file of ["package.json", "package-lock.json", "README.md", "install.mjs", "repair.mjs", "archive.mjs", "patch-core.mjs", "register-maintenance.ps1", "run-maintenance.ps1", "install.cmd", "uninstall.cmd"]) {
