...
const newPath = "`extensions`,`LinearCN`,`1.5.1`";
const oldLogs = [
...
const newLog = "LinearCN Enhanced 1.5.1 loaded";
...
if ((patched.split(newLog).length - 1) !== 1) throw new Error("Expected one 1.5.1 loader log marker");
