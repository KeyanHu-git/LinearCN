...
const newPath = "`extensions`,`LinearCN`,`1.5.0`";
const oldLogs = [
  "LinearCN 1.2.0 loaded",
  "LinearCN Enhanced 1.3.0 loaded",
  "LinearCN Enhanced 1.4.0 loaded"
];
const newLog = "LinearCN Enhanced 1.5.0 loaded";
...
if ((patched.split(newLog).length - 1) !== 1) throw new Error("Expected one 1.5.0 loader log marker");
