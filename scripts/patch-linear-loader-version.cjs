...
const newPath = "`extensions`,`LinearCN`,`1.5.2`";
const oldLogs = [
...
const newLog = "LinearCN Enhanced 1.5.2 loaded";
...
if ((patched.split(newLog).length - 1) !== 1) throw new Error("Expected one 1.5.2 loader log marker");
